package com.iambhvsh.shelf.data.local.repository
...
import com.iambhvsh.shelf.data.local.mapper.toDomain
import com.iambhvsh.shelf.data.local.mapper.toEntity
...
import com.iambhvsh.shelf.utils.Resource
...
class BookmarkRepositoryImpl(
    ...
    override suspend fun createCollection(name: String): Long {
        return collectionDao.insertCollection(
            com.iambhvsh.shelf.data.local.entity.CollectionEntity(name = name)
        )
    }
